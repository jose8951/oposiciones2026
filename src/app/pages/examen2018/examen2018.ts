...
@Component({
  selector: 'app-examen2018',
  imports: [],
  templateUrl: './examen2018.html',
  styleUrl: './examen2018.css',
})
export class Examen2018 implements OnInit{
 ...
 private examenService = inject(ExamenService);
  ...
  ngOnInit(): void {
    ...
    this.examenService.obtenerExamen('2018').subscribe({
      next: (resultado) => {
